...
* It shows which categories (Tops, Dresses, Outerwear) and which customer groups (new users, app users) face the most issues.*
* It gives simple, practical solutions like better size charts, limiting COD for new users, and improving product photos & details.*
* It also suggests testing ideas (like an A/B test for size tools) and gives clear limitations and assumptions to make the analysis reliable.*
